...
class _MyAppState extends State<MyApp> {
  ...
  final ValueNotifier<String> _test = ValueNotifier<String>('');
  ...
  void initState() {
    ...
    _state = DemoAppStateManager(
        screen: _screen, counter: _counter, text: _text, test: _test);
  ...
  Widget demoScreenRouter(DemoScreen which) {
    switch (which) {
      case DemoScreen.counter:
        ...
        return const SidePanel(); // Replace with your SidePanel widget
